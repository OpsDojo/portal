        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Weight_WeightLbs = table.Column<decimal>(type: "decimal(10,6)", nullable: false, computedColumnSql: "CAST([WeightKg] / 0.45359237 AS decimal(10,6))", stored: true),
                    Weight_WeightStone = table.Column<decimal>(type: "decimal(10,6)", nullable: false, computedColumnSql: "CAST([WeightKg] / 6.35029318 AS decimal(10,6))", stored: true),
